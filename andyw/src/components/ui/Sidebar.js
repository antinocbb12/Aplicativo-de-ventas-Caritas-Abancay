...
const Sidebar = () => {
    return ( 
        ...
        <div className="p-6">
            <p className="uppercase text-white text-2xl tracking-wide text-center font-bold">LicoreriaApp</p>

            <p className="mt-3 text-gray-600">Administra tu Licoreria en las siguientes opciones:</p>
