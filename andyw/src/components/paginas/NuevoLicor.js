 ...
 const navigate = useNavigate();
    ...
    const formik = useFormik({
        ...
        validationSchema: Yup.object({
            nombre: Yup.string()
                        .min(3, 'Los Pedidos deben tener al menos 3 caracteres')
                        .required('El Nombre del licor es obligatorio'),
            precio: Yup.number()
    ...
    return (
        <>
        <h1 className="text-3xl font-light mb-4">Agregar Licor</h1>
                    ...
                    <div className="mb-4">
                        ...
                        <div className="mb-4">
                            ...
                            >
                                ...
                                <option value="wiski">wiski</option>
